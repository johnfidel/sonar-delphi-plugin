 ...
 */
public class DelphiLintIssuesLoaderSensor implements Sensor {
   ...
   */
  public DelphiLintIssuesLoaderSensor(final Configuration config, final FileSystem fileSystem) {
    this.config = config;
  ...
  private static String getRepositoryKeyForLanguage(String languageKey) {
    return languageKey.toLowerCase() + "-" + DelphiLintRulesDefinition.KEY;
  }
